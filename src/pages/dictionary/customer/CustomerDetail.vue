            ...
            <div class="customer-detail flex flex-col gap-4">
                <div class="flex gap-4 max-md:flex-col">
                    ...
                    <BaseInput
                        ...
                        :label="$t('i18nCustomer.Detail.CustomerName')"
                        class="w-1/2 max-md:w-full"
                    />
                </div>
                ...
                <div class="flex gap-4 max-md:flex-col">
                    ...
                    <BaseInput
                        ...
                        :label="$t('i18nCustomer.Detail.TaxCode')"
                        class="w-1/2 max-md:w-full"
                    />
                </div>

                <BaseInput v-model="model.Address" :label="$t('i18nCustomer.Detail.Address')" class="w-full" />
            </div>
        </template>
